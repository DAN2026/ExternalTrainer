...
class UtilitiesOverlaysPage(BasePage):
    """
    Handles in-game HUD and ESP overlay settings.
    """
    ...
    def build(self) -> None:
        with dpg.child_window(
            ...
            with dpg.group(tag="overlays-group-container"):
                ToggleRowComponent(
                    "draw_crosshair", "Custom Crosshair", "folder",
                    on_true=lambda: print("Crosshair On"),
